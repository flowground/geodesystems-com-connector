 ...
 * Endpoint Path: '/repository/search/type/type_reuters_document'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'search_type_reuters_document',
        pathName: '/repository/search/type/type_reuters_document',
        method: 'get',
