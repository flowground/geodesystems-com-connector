 ...
 * Endpoint Path: '/repository/search/type/tasks'
 * Method: 'get'
 *
 */
...
const FIELD_MAP = {
    ...
    "max": "max",
    "skip": "skip",
    "search_db_tasks_title": "search.db_tasks.title",
    "search_db_tasks_priority": "search.db_tasks.priority",
    "search_db_tasks_status": "search.db_tasks.status",
    "search_db_tasks_complete": "search.db_tasks.complete",
    "search_db_tasks_assignedto": "search.db_tasks.assignedto",
    "search_db_tasks_startdate": "search.db_tasks.startdate",
    "search_db_tasks_enddate": "search.db_tasks.enddate"
};
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/repository/search/type/tasks',
        method: 'get',
