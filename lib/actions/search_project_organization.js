 ...
 * Endpoint Path: '/repository/search/type/project_organization'
 * Method: 'get'
 *
 */
...
const FIELD_MAP = {
    ...
    "max": "max",
    "skip": "skip",
    "search_project_organization_organization_type": "search.project_organization.organization_type",
    "search_project_organization_status": "search.project_organization.status"
};
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/repository/search/type/project_organization',
        method: 'get',
