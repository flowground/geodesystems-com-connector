 ...
 * Endpoint Path: '/repository/search/type/type_point_collection'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'search_type_point_collection',
        pathName: '/repository/search/type/type_point_collection',
        method: 'get',
