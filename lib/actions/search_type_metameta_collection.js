 ...
 * Endpoint Path: '/repository/search/type/type_metameta_collection'
 * Method: 'get'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'search_type_metameta_collection',
        pathName: '/repository/search/type/type_metameta_collection',
        method: 'get',
