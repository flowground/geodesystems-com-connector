 ...
 * Endpoint Path: '/repository/search/type/type_nist_constant'
 * Method: 'get'
 *
 */
...
const FIELD_MAP = {
    ...
    "max": "max",
    "skip": "skip",
    "search_type_nist_constant_unit": "search.type_nist_constant.unit"
};
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        spec: spec,
        operationId: 'search_type_nist_constant',
        pathName: '/repository/search/type/type_nist_constant',
        method: 'get',
